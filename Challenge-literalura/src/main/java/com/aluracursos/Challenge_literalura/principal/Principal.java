    ...
    public void menu() {
        ...
        public void buscarLibrosPorTitulo(){
            ...
            opcionLibro=teclado.nextLine();
                ...
                System.out.println("Busqueda"+datosBusqueda);
            ...
            if(libroBuscado.isPresent()){
                System.out.println("El libro existe y es: "+libroBuscado);
            }else{
                System.out.println("El libro no existe");
            }

            Libro libro =new Libro(libroBuscado.get());
            System.out.println(libro.getAutor().size());
            var id=libro.getId();
            System.out.println(id);
            for (int i = 0; i < libroBuscado.get().autor().size(); i++) {
                Autor autor=new Autor(libroBuscado.get().autor().get(i));
